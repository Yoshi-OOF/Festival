...
<head>
    ...
    <style>
        /* Styles CSS pour la page des organisateurs */
        body {
...
<body>
    ...
    <main>
        <section id="organisateurs">
            ...
            <h3>Équipe</h3>
            <ul class="members">
                <li><strong>Jean Dupont</strong> - Président</li>
                <li><strong>Marie Martin</strong> - Responsable Communication</li>
                <li><strong>Lucie Durand</strong> - Coordinatrice Logistique</li>
                <li><strong>Thomas Bernard</strong> - Responsable Technique</li>
                <li><strong>Camille Leroy</strong> - Responsable Relations Partenaires</li>
